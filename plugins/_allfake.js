...
global.kontak2 = [
[owner[0], await conn.getName(owner[0] + '6283849469400@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'busarderemik@gmail.com', true],
[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'busarderemik@gmail.com', true],
]
